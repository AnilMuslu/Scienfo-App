...
class MathematicsContentPage extends StatefulWidget {
  MathematicsContentPage({Key? key}) : super(key: key);

  @override
  _MathematicsContentPageState createState() => _MathematicsContentPageState();
}

class _MathematicsContentPageState extends State<MathematicsContentPage> {
  final FirebaseService firebaseService = FirebaseService();

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: firebaseService.getMathematicsImagesStream(),
