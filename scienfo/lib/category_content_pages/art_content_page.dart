...
class ArtContentPage extends StatefulWidget {
  ArtContentPage({Key? key}) : super(key: key);

  @override
  _ArtContentPageState createState() => _ArtContentPageState();
}

class _ArtContentPageState extends State<ArtContentPage> {
  ...
  */
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: firebaseService.getArtImagesStream(),
