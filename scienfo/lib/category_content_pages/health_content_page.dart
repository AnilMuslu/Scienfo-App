...
class HealthContentPage extends StatefulWidget {
  HealthContentPage({Key? key}) : super(key: key);

  @override
  _HealthContentPageState createState() => _HealthContentPageState();
}

class _HealthContentPageState extends State<HealthContentPage> {
  ...
  */
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: firebaseService.getHealthImagesStream(),
