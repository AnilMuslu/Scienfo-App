...
class NutritionContentPage extends StatefulWidget {
  NutritionContentPage({Key? key}) : super(key: key);

  @override
  _NutritionContentPageState createState() => _NutritionContentPageState();
}

class _NutritionContentPageState extends State<NutritionContentPage> {
  ...
  */
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: firebaseService.getNutritionImagesStream(),
