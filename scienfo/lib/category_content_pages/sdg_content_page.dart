...
class SDGContentPage extends StatefulWidget {
  SDGContentPage({Key? key}) : super(key: key);

  @override
  _SDGContentPageState createState() => _SDGContentPageState();
}

class _SDGContentPageState extends State<SDGContentPage> {
